...
**Whoosh-NG** is a modern, pure-Python full-text indexing and search library. Version 4.3.0 brings a complete modernization with Python 3.11+ support, strict type annotations, optional feature profiles, and automated semantic releases.

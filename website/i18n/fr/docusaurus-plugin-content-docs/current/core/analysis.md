...
- [Stemming & Stop Words](/core/stemming) â€” Practical stemming and stop-word guides
- [N-grams](/core/ngrams) â€” Substring and prefix matching with N-gram analyzers
- [API: analysis](../api/analysis) â€” Full reference for analyzers, tokenizers, and filters
